          ...
          >
            ...
            <div className="mt-4 flex justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#25D366] hover:bg-[#20ba5a] text-white text-sm font-bold rounded-xl shadow-md shadow-green-500/20 transition-colors"
              >
